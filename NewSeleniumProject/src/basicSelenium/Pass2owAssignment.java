...
public class Pass2owAssignment {
	@Test
	public void Book1PassengerItinerery() throws InterruptedException {
		...
		System.out.println(dr.findElement(By.xpath("//input[@value='Business']")).isSelected());
		...
		//Return
		System.out.println(dr.findElement(By.xpath("//input[@value='Blue Skies Airlines$631$273$14:30']")).isSelected());
		...
		dr.findElement(By.name("passFirst1")).sendKeys("Ritesh");
		dr.findElement(By.name("passLast1")).sendKeys("Bhagat");
		//meal
		...
		Select sel14=new Select(meal1);
		sel14.selectByVisibleText("Hindu");
		//credit card
